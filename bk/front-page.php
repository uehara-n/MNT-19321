...
?></p>
    ...
    <!-- スタッフブログ -->
    <section id="top-staff-blog" class="section bg3">
      <div class="centering">
			<h2 class="heading-top"><img class="sp-fit" src="<?php echo get_template_directory_uri(); ?>/img/top/heading-staff-blog.png" alt="スタッフブログ"></h2>
			<div class="grid-row mt30">
			<?php
			$args = array(
				'post_type' => 'staff-blog',
			...
			$domestic_post = get_posts($args);
			if($domestic_post) : foreach($domestic_post as $post) : setup_postdata( $post ); ?>
			<div class="col span3 post">
				<div class="image image-scale">
          <a href="<?php the_permalink() ?>">
	<img src="<?php echo catch_that_image(); ?>" alt="<?php the_title(); ?>" class="object-fit" />
</a>
				</div>
		...
		wp_reset_postdata(); ?>
				...
				<p class="sp-none center">
          <a href="<?php echo home_url(); ?>/staff-blog/"><img src="<?php echo get_template_directory_uri(); ?>/img/top/btn-staff-blog.png" alt="もっとスタッフブログを見る"></a>
        </p>
        <p class="pc-none center">
          <a href="<?php echo home_url(); ?>/staff-blog/"><img src="<?php echo get_template_directory_uri(); ?>/img/top/btn-staff-blog-sp.png" class="fit" alt="もっとスタッフブログを見る"></a>
        </p>
    </div>
		</section>
